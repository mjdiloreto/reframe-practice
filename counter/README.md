...
* [`src/cljs/counter/`](src/cljs/counter/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/counter/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `counter` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/counter/config.cljs) defaults to `true` in
...
```clj
(ns counter.example
  (:require [counter.config :as config])
